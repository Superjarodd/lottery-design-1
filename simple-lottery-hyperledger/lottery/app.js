...
app.all('/ticket', function(req, res){    
...
// createInvoice chaincode function - requires 5 args, ex: args: ['CAR12', 'Honda', 'Accord', 'Black', 'Tom'],
// changeInvoiceOwner chaincode function - requires 2 args , ex: args: ['CAR10', 'Dave'],
...
if (req.method == "POST")
{
  request.fcn='createLottery';
  newTicket.push(name);
}

request.args=newTicket;
console.log(request);
...
// queryAllLotteries chaincode function - requires no arguments , ex: args: [''],
const request = {
//targets : --- letting this default to the peers assigned to the channel
chaincodeId: 'lottery',
fcn: 'queryAllLotteries',
args: ['']
};
...
{
  ar.push(supplier);
  request.fcn='queryInvBySupplier';
  request.args = ar;
}
else if (oem)
{
  ar.push(oem);
  request.fcn='queryInvByOEM';
  request.args = ar;
}
